...
const Register = () => {
  ...
  const {createUser, updateUserProfile} = useContext(AuthContext)
    ...
    return (
        <div className='bg-[url("/others/authentication.png")] w-screen fixed left-0 h-screen md:flex items-center justify-center'>
        <div>
          <img className='md:max-w-[648px] lg:w-[648px]' src={bg_login_img} alt="Login Background" />
        </div>
        <form onSubmit={handleRegister} className="md:w-[536px] p-6 shadow-lg rounded-lg flex flex-col items-center justify-around">
