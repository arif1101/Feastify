              ...
              <table className="w-full border-collapse border bg-gray-100 shadow-md rounded-lg">
                ...
                <tbody>
                  {users.map((user, index) => (
                    <tr key={user._id} className="border bg-white hover:bg-gray-200 transition duration-200">
                      ...
                      <td className="p-4 border text-center">
                        ...
                        >
                          {user.role === "admin" ? <FaUserShield className="text-xl" /> : <FaUsers className="text-xl" />}
                          <span className="text-sm font-semibold">{user.role === "admin" ? "Admin" : "User"}</span>
                        </button>
                      </td>
                      {/* end user role  */}
                      <td className="p-4 border text-center">
